 ...
 * 未受理页面
 */
public class UnRepiredFragment extends Fragment implements
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        NetworkHelper.getInstance().getRepireList(this, "0", AppOptions.USERINFO.user.getPhoneNumber(), ONCE_LOAD, pageIndex);
    }
    ...
    public void onGotUnRepiredData(ArrayList<RepireBean> unRepiredList, int totalCount) {
        refreshLayout.setRefreshing(false);
        loadingNext = false;
        if (totalCount != 0 && unRepiredList != null) {
            this.totalCount = totalCount;
            this.loadedCount += unRepiredList.size();
            this.adapter.addData(unRepiredList);
        } else {

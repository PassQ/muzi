...
public class QuestionAdapter extends RecyclerView.Adapter {
    ...
    private OnQuestionScrollAtBottomCallback scrollAtBottomCallback;
    private OnRecycleViewClickCallbacks.OnQuestionListClickCallback onQuestionListClickCallback;
     ...
     */
    public void addQuestionBean(ArrayList<ArtclesBean> artclesBeen) {
    ...
    public void setScrollAtBottomCallback(OnQuestionScrollAtBottomCallback scrollAtBottomCallback) {
        this.scrollAtBottomCallback = scrollAtBottomCallback;
    }

    public void setOnQuestionListClickCallback(OnRecycleViewClickCallbacks.OnQuestionListClickCallback onQuestionListClickCallback) {
        this.onQuestionListClickCallback = onQuestionListClickCallback;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (artclesBeen.size() > 0 && position == artclesBeen.size() - 1 && scrollAtBottomCallback != null) {
            scrollAtBottomCallback.onQuestionScrollAtBottom();
        }
    ...
    class HelpaskViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (onQuestionListClickCallback != null && artclesBeen.size() > 0 && getAdapterPosition() >= 0 && getAdapterPosition() < artclesBeen.size()) {
                onQuestionListClickCallback.onQuestionListClick(artclesBeen.get(getAdapterPosition()), getAdapterPosition());
            }
        }
    }

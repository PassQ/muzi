 ...
 * 获取 公益展示 数据列表回调
 */
public interface OnGetContribuListCallbacak {
     ...
     */
    void onGotContribuList(String pageSize, int totalCount, String index, ArrayList<ArtclesBean> artclesBeen);
     ...
     */
    void onGotContribuFailed(boolean isException);
